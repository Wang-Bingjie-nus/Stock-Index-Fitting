...
from .pareto_risk_optimizer_v02 import (
...
def build_component_rules_from_weights(
    ...
    """Attach the same board-level buy rules used by correlation_v03."""
...
def build_target_portfolio_for_weights(
    ...
    *,
    ...
    """Build the amount-greedy base exactly as in correlation_v03."""
...
def build_pareto_portfolio_for_weights(
    ...
    *,
    ...
    """Amount-greedy base followed by the existing Pareto risk optimizer."""

    if not allow_over_budget:
        raise ValueError(
            "v03 requires allow_over_budget=True for the confirmed funding interval."
        )
